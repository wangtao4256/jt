 ...
 * Generated at: 2017-05-11 08:43:45 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</div>\r\n");
      out.write("<script>\r\n");
      out.write("\t//获取选中的记录的id串\r\n");
      out.write("    function getSelectionsIds(){\r\n");
      out.write("    \tvar itemList = $(\"#itemList\");\t//获取列表对象\r\n");
      out.write("    \tvar sels = itemList.datagrid(\"getSelections\");\t//EasyUI.datagrid提供方法\r\n");
      out.write("    \tvar ids = [];\r\n");
      out.write("    \tfor(var i in sels){\r\n");
      out.write("    \t\tids.push(sels[i].id);\r\n");
      out.write("    \t}\r\n");
      out.write("    \tids = ids.join(\",\");\t//把数组一个字符串，利用逗号分隔\r\n");
      ...
      out.write("        handler:function(){\r\n");
      out.write("        \tvar ids = getSelectionsIds();\t//获取选中所有id值\r\n");
      out.write("        \tif(ids.length == 0){\r\n");
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids};\t//k,v，告诉后台获取参数的名称，ids\r\n");
      out.write("        \t    \talert(ids);\r\n");
